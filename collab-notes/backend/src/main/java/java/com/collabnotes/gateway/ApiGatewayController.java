package java.com.collabnotes.gateway;
...
import java.com.collabnotes.metadata.DocumentMetadata;
...
public class ApiGatewayController {
    ...
    public ResponseEntity<DocumentMetadata> createDocument(@RequestBody CreateDocumentRequest request) {
        log.info("API Gateway: POST /docs - Creating document: {}", request.getTitle());
        DocumentMetadata metadata = metadataService.createDocument(request.getTitle(), request.getCreatedBy());
